...
import {
  ...
  getDeleteBoardAndTaskModalTitleValue,
  getDeleteBoardAndTaskModalIndexValue,
  getDeleteBoardAndTaskModalStatusValue,
  getPageTitle,
...
export default function DeleteBoardAndTaskModal() {
  ...
  const taskTitle = useAppSelector(getDeleteBoardAndTaskModalTitleValue);
  const taskIndex = useAppSelector(getDeleteBoardAndTaskModalIndexValue);
  const taskStatus = useAppSelector(getDeleteBoardAndTaskModalStatusValue);
